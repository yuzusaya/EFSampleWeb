...
namespace EFSampleWeb.Controllers
{
    ...
    public class ItemsController : Controller
    {
        ...
        public ItemsController(EfsampleDatabaseContext context)
        {
            _context = context;
        }
        ...
        {
            var efsampleDatabaseContext = _context.Item.Include(i => i.Category);
            return View(await efsampleDatabaseContext.ToListAsync());
        }
